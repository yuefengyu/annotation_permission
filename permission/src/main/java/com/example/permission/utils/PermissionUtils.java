...
import com.example.permission.menu.DefaultSettingIntent;
import com.example.permission.menu.HWSettingIntent;
import com.example.permission.menu.IMenu;
import com.example.permission.menu.MIUISettingIntent;
import com.example.permission.menu.MeizuSettingIntent;
import com.example.permission.menu.OppoSettingIntent;
...
public class PermissionUtils {
    ...
    static {
        permissionMenu.put(MANUFACTURER_DEFAULT, DefaultSettingIntent.class);
        permissionMenu.put(MANUFACTURER_OPPO, OppoSettingIntent.class);
        permissionMenu.put(MANUFACTURER_VIVO, MIUISettingIntent.class);
        permissionMenu.put(MANUFACTURER_VIVO, MeizuSettingIntent.class);
        permissionMenu.put(MANUFACTURER_VIVO, HWSettingIntent.class);
    }
